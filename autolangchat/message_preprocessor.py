...
def _get_tool_result_payload(tr: dict) -> tuple[str, str]:
    ...
    The autolangchat tool message format uses ``"result"`` as the key, while some
...
class MessagePreprocessor:
    ...
    async def preprocess_messages(
        ...
        *,
        ...
        This is the primary entry point called by the LangGraph preprocessing node.  It
    ...
    async def _truncate_single_message(
        ...
        """
        # Tool result messages: payload is in tool_results, not content
    ...
    async def _truncate_result_entries(
        ...
        Used for tool result messages where the real payload
