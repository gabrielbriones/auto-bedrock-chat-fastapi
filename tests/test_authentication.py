...
from auto_bedrock_chat_fastapi.session_manager import ChatSession, Credentials as SessionCredentials
...
class TestAuthenticationConfiguration:
    ...
    def test_auth_config_defaults(self):
        ...
        assert config.supported_auth_types == [
            "bearer_token",
            "basic_auth",
            "api_key",
            "oauth2",
